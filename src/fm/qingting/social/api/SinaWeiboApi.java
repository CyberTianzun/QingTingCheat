...
public class SinaWeiboApi
{
  ...
  private static void shareImageInternal(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, ISocialEventListener paramISocialEventListener)
  {
    ...
    if ((localOauth2AccessToken != null) && (localOauth2AccessToken.isSessionValid()))
    {
      WeiboParameters localWeiboParameters = buildStatusParam(paramString1, paramString4, paramString3);
      localWeiboParameters.add("url", paramString2);
      localWeiboParameters.add("access_token", localOauth2AccessToken.getToken());
      localWeiboParameters.add("pic_id", (String)null);
      new AsyncWeiboRunner(paramContext).requestAsync("https://api.weibo.com/2/statuses/upload_url_text.json", localWeiboParameters, "POST", new SinaWeiboListener(paramISocialEventListener));
    }
  }
  ...
  private static void shareLocalImageInternal(Context paramContext, String paramString1, String paramString2, ISocialEventListener paramISocialEventListener)
  {
    ...
    if ((localOauth2AccessToken != null) && (localOauth2AccessToken.isSessionValid()))
    {
      WeiboParameters localWeiboParameters = buildStatusParam(paramString1, "", "");
      File localFile = new File(paramString2);
      if (localFile.exists())
      {
        localWeiboParameters.add("pic", localFile.getAbsolutePath());
        localWeiboParameters.add("access_token", localOauth2AccessToken.getToken());
        new AsyncWeiboRunner(paramContext).requestAsync("https://api.weibo.com/2/statuses/upload.json", localWeiboParameters, "POST", new SinaWeiboListener(paramISocialEventListener));
      }
    }
  }
  ...
  private static void shareTextInternal(Context paramContext, String paramString1, String paramString2, String paramString3, ISocialEventListener paramISocialEventListener)
  {
    ...
    {
      Oauth2AccessToken localOauth2AccessToken = SinaWeiboAuth.getToken();
      WeiboParameters localWeiboParameters = buildStatusParam(paramString1, paramString3, paramString2);
      localWeiboParameters.add("access_token", localOauth2AccessToken.getToken());
      new AsyncWeiboRunner(paramContext);
      new AsyncWeiboRunner(paramContext).requestAsync("https://api.weibo.com/2/statuses/update.json", localWeiboParameters, "POST", new SinaWeiboListener(paramISocialEventListener));
    }
  }
}
