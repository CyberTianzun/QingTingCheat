  ...
  implements AsyncHttpServerRequest, CompletedCallback
{
  ...
  LineEmitter.StringCallback mHeaderCallback = new LineEmitter.StringCallback()
  {
    public void onStringAvailable(String paramAnonymousString)
    {
      ...
      {
        AsyncHttpServerRequestImpl.this.onCompleted(localException);
        return;
      }
      DataEmitter localDataEmitter = HttpUtil.getBodyDecoder(AsyncHttpServerRequestImpl.this.mSocket, AsyncHttpServerRequestImpl.this.mRawHeaders, true);
      AsyncHttpServerRequestImpl.this.mBody = HttpUtil.getBody(localDataEmitter, AsyncHttpServerRequestImpl.this.mReporter, AsyncHttpServerRequestImpl.this.mRawHeaders);
      AsyncHttpServerRequestImpl.this.mBody.parse(localDataEmitter, AsyncHttpServerRequestImpl.this.mReporter);
  ...
  void setSocket(AsyncSocket paramAsyncSocket)
  {
    ...
    this.mSocket.setDataCallback(localLineEmitter);
