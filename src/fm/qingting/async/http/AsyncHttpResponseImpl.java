  ...
  implements AsyncHttpResponse
{
  ...
  LineEmitter.StringCallback mHeaderCallback = new LineEmitter.StringCallback()
  {
    ...
    public void onStringAvailable(String paramAnonymousString)
    {
      ...
      {
        AsyncHttpResponseImpl.this.report(localException);
        return;
      }
      ...
      {
        DataEmitter localDataEmitter = HttpUtil.getBodyDecoder(AsyncHttpResponseImpl.this.mSocket, this.mRawHeaders, false);
        AsyncHttpResponseImpl.this.setDataEmitter(localDataEmitter);
      }
    }
  };
