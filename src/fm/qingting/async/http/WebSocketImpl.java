  ...
  implements WebSocket
{
  ...
  public WebSocketImpl(AsyncHttpServerRequest paramAsyncHttpServerRequest, AsyncHttpServerResponse paramAsyncHttpServerResponse)
  {
    ...
    String str1 = paramAsyncHttpServerRequest.getHeaders().getHeaders().get("Sec-WebSocket-Key");
    String str2 = SHA1(str1 + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11");
    ...
    paramAsyncHttpServerResponse.getHeaders().getHeaders().set("Sec-WebSocket-Accept", str2);
  ...
  private static String SHA1(String paramString)
  {
    try
    {
      ...
      String str = Base64.encodeToString(localMessageDigest.digest(), 0);
      return str;
    }
  ...
  private void addAndEmit(ByteBufferList paramByteBufferList)
  {
    ...
    do
    {
      ...
      while (!isPaused())
      {
        ByteBufferList localByteBufferList = (ByteBufferList)this.pending.remove();
        Util.emitAllData(this, localByteBufferList);
        if (localByteBufferList.remaining() > 0)
          this.pending.add(0, localByteBufferList);
      }
    }
  ...
  public static WebSocket finishHandshake(RawHeaders paramRawHeaders, AsyncHttpResponse paramAsyncHttpResponse)
  {
    ...
    do
    {
      do
      {
        ...
        str1 = paramAsyncHttpResponse.getHeaders().getHeaders().get("Sec-WebSocket-Accept");
      }
      while (str1 == null);
      str2 = paramRawHeaders.get("Sec-WebSocket-Key");
    }
    while ((str2 == null) || (!str1.equalsIgnoreCase(SHA1(str2 + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11").trim())));
    WebSocketImpl localWebSocketImpl = new WebSocketImpl(paramAsyncHttpResponse.detachSocket());
    localWebSocketImpl.setupParser(true);
    return localWebSocketImpl;
  }
