...
public class StatisticsFMManage extends Application
{
  ...
  {
    boolean bool1 = getISSendUse();
    boolean bool2 = false;
    if (bool1)
    {
      boolean bool3 = this.mUsedFM;
      bool2 = false;
      if (bool3)
      {
        setSendUse(false);
  ...
  {
    long l = paramLong + getFmtime();
    this.editor.putLong("key_fmtime", l);
    this.editor.commit();
    if (l > 0L)
      sendMessage();
  }
  ...
  {
    long l = paramLong + getNETtime();
    this.editor.putLong("key_nettime", l);
    this.editor.commit();
    if (l > 60000L)
      this.mUsedNET = true;
  }
  ...
  {
    long l = paramLong + getScanTime();
    this.editor.putLong("key_scantime", l);
    this.editor.commit();
  }
  ...
  public void setVertion(Context paramContext)
  {
    ...
    this.editor.putString("key_vertionfm", str);
    this.editor.commit();
  }
}
