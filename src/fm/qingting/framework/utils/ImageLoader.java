...
public class ImageLoader
{
    ...
    implements ImageLoader.ImageListener
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      if (paramObject != null)
      {
        boolean bool2 = paramObject instanceof MyImageListener;
        bool1 = false;
        if (bool2)
        {
          MyImageListener localMyImageListener = (MyImageListener)paramObject;
          ImageLoaderHandler localImageLoaderHandler1 = this.handler;
          ImageLoaderHandler localImageLoaderHandler2 = localMyImageListener.handler;
          bool1 = false;
          if (localImageLoaderHandler1 == localImageLoaderHandler2)
          {
            int i = this.width;
            int j = localMyImageListener.width;
            bool1 = false;
            if (i == j)
            {
              int k = this.height;
              int m = localMyImageListener.height;
              bool1 = false;
              if (k == m)
                bool1 = true;
            }
          ...
          if (!bool1)
            ImageLoader.log("(ML:false)" + this.handler + ":" + localMyImageListener.handler);
        }
      }
      return bool1;
    }
