  ...
  private IResultRecvHandler resultRecver = new IResultRecvHandler()
  {
    public void onRecvResult(Result paramAnonymousResult, Object paramAnonymousObject1, IResultToken paramAnonymousIResultToken, Object paramAnonymousObject2)
    {
      ...
      if (paramAnonymousResult.getSuccess())
      {
        ...
        {
          RegionMessageHandler.this.writeToDB(localProgramNode);
      ...
      RegionMessageHandler.this.writeToDB(localNode);
      RegionMessageHandler.this.sendNotification();
    }
  };
    ...
    while (true)
    {
      ...
      try
      {
        ...
        if (!isOutOfDate())
        {
          ...
          {
            this.mCategoryId = localJSONObject.getIntValue("cat_id");
            this.mChannelId = localJSONObject.getIntValue("channel_id");
            this.mProgramId = localJSONObject.getIntValue("program_id");
            this.mContentType = 1;
