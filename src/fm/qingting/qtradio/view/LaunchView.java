  ...
  implements InfoManager.ISubscribeEventListener, ViewElement.OnElementClickListener
{
  ...
  public LaunchView(Context paramContext, boolean paramBoolean)
  {
    ...
    String str = null;
    if (paramBoolean)
      str = SharedCfg.getInstance().getLocalAdvertisementPic();
    ...
    this.mMask.setImageRes(2130837806);
    ...
    try
    {
      if (!str.equalsIgnoreCase(""))
      {
        ...
        if (localBitmap != null)
        {
          this.mAdvertisementElement.setImageBitmap(localBitmap);
  ...
  private void handleAdvertisementPic()
  {
    ...
    if (str1 != null)
    {
      ...
      String str2 = SharedCfg.getInstance().getNetAdvertisementPic();
      String str3 = SharedCfg.getInstance().getLocalAdvertisementPic();
      if ((str2 != null) && (str2.equalsIgnoreCase(str1)) && (str3 != null))
    ...
    SimpleImageloader localSimpleImageloader = new SimpleImageloader();
    localSimpleImageloader.ready(true);
    localSimpleImageloader.setNetAdvertisementPic(str1);
    localSimpleImageloader.execute(new Object[] { str1 });
    InfoManager.getInstance().root().mAdvertisementInfoNode.getSplashAdvertisement().onShow();
  }
  ...
  private void initElementAndLayout(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    this.mType = 1;
    if (paramBoolean)
      this.mType = (0x4 | this.mType);
    if (paramInt1 != 8)
      this.mType = (0x2 | this.mType);
  ...
  private void initFrWithAd(int paramInt1, int paramInt2)
  {
    ...
    case 0:
      ...
      this.mChannelElement.setImageRes(2130837906);
    ...
    case 10:
      ...
      this.mChannelElement = new ImageViewElement(getContext());
      this.mChannelElement.setImageRes(2130837913);
      addElement(this.mChannelElement, paramInt2);
      return;
    case 11:
    ...
    case 15:
      ...
      this.mChannelElement = new ImageViewElement(getContext());
      this.mChannelElement.setImageRes(2130837909);
      addElement(this.mChannelElement, paramInt2);
      return;
    case 16:
    }
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    ...
    {
      String str = SharedCfg.getInstance().getSplashLanding();
      if ((str != null) && (!str.equalsIgnoreCase("")))
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length > 4))
        {
          ...
          int k = Integer.valueOf(arrayOfString[3]).intValue();
          int m = Integer.valueOf(arrayOfString[4]).intValue();
          ControllerManager.getInstance().openChannelDetailController(i, j, k, m, null, true);
        }
      }
    }
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    else
    {
      ...
      this.mVersionElement.setTextSize(0.5F * this.copyrightLayout.height);
      if (this.mType != 1)
        break label506;
