...
class HeaderView extends QtView
{
  ...
  public HeaderView(Context paramContext)
  {
    ...
    this.mImageViewElement.setDefaultImageRes(2130837978);
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    {
      SpecialTopicNode localSpecialTopicNode = (SpecialTopicNode)paramObject;
      this.mImageViewElement.setImageUrl(localSpecialTopicNode.thumb, false);
      this.mName.setText(localSpecialTopicNode.desc);
      requestLayout();
      String str = QTLogger.getInstance().buildSpecialTopicLog(localSpecialTopicNode);
      if (str != null)
        LogModule.getInstance().send("topic_v6", str);
    }
  }
}
