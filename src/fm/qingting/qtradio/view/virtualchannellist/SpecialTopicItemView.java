  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public SpecialTopicItemView(Context paramContext, int paramInt)
  {
    ...
    this.mHeatLabelElement.setImageRes(2130837744);
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    ...
    do
    {
      ...
      str = QTLogger.getInstance().buildSpecialTopicClickLog(this.mNode.channelId, this.mNode.channelType);
    }
    while (str == null);
    LogModule.getInstance().send("topic_click_v6", str);
  }
