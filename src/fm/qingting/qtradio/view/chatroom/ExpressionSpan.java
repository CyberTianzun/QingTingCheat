...
public class ExpressionSpan extends ReplacementSpan
{
  ...
  public void draw(Canvas paramCanvas, CharSequence paramCharSequence, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    if ((this.mResId == 0) || (this.mWidth == 0) || (this.mHeight == 0) || (this.mResources == null))
      return;
    paramCanvas.save();
    Bitmap localBitmap = BitmapResourceCache.getInstance().getResourceCacheByParent(this.mResources, this.mOwnerId, this.mResId);
    paramCanvas.drawBitmap(localBitmap, new Rect(0, 0, localBitmap.getWidth(), localBitmap.getHeight()), new RectF(2.0F + paramFloat, (paramInt3 + paramInt5 - this.mHeight) / 2, 2.0F + paramFloat + this.mWidth, (paramInt3 + paramInt5 + this.mHeight) / 2), null);
    paramCanvas.restore();
  }

  public int getSize(Paint paramPaint, CharSequence paramCharSequence, int paramInt1, int paramInt2, Paint.FontMetricsInt paramFontMetricsInt)
  {
    return 4 + this.mWidth;
  }
}
