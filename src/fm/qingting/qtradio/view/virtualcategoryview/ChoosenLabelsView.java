...
{
  private final ViewLayout buttonLayout = this.standardLayout.createChildLT(154, 68, 558, 10, ViewLayout.SCALE_FLAG_SLTCW);
  private final ViewLayout labelLayout = this.standardLayout.createChildLT(550, 88, 0, 0, ViewLayout.SCALE_FLAG_SLTCW);
  ...
  private final ViewLayout standardLayout = ViewLayout.createViewLayoutWithBoundsLT(720, 88, 720, 88, 0, 0, ViewLayout.FILL);
  ...
  public ChoosenLabelsView(Context paramContext)
  {
    ...
    this.mButton = ((Button)LayoutInflater.from(paramContext).inflate(2130903050, null));
