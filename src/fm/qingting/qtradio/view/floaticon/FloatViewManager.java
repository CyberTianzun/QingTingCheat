...
public enum FloatViewManager
{
  ...
  static
  {
    FloatViewManager[] arrayOfFloatViewManager = new FloatViewManager[1];
    arrayOfFloatViewManager[0] = INSTANCE;
  }
  ...
  public void createSmallWindow(Context paramContext)
  {
    ...
    float f2 = i;
    if (this.mV2);
    for (float f3 = 128.0F; ; f3 = f1)
    {
      int k = (int)(f3 * f2 / 720.0F);
      float f4 = i;
      if (this.mV2)
        f1 = 130.0F;
      int m = (int)(f1 * f4 / 720.0F);
