...
class UserGuideGenderView extends QtView
{
  ...
  public UserGuideGenderView(Context paramContext)
  {
    ...
    this.mBoyElement.setParam("男", 2130837997);
    addElement(this.mBoyElement, i);
    this.mGirlElement = new CheckElement(paramContext);
    this.mGirlElement.setParam("女", 2130837998);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mBoyElement.measure(j, i, j + this.checkLayout.width, i + this.checkLayout.height);
    int k = j + j + this.checkLayout.width;
    this.mGirlElement.measure(k, i, k + this.checkLayout.width, i + this.checkLayout.height);
    int m = this.titleLayout.topMargin;
    this.mTitleElement.measure(0, m, this.standardLayout.width, m + this.titleLayout.height);
    int n = this.subTitleLayout.topMargin;
    this.mSubTitleElement.measure(0, n, this.standardLayout.width, n + this.subTitleLayout.height);
