  ...
  implements View.OnClickListener, View.OnKeyListener
{
  ...
  {
    super(paramContext);
    this.mContentView = ((RelativeLayout)inflate(paramContext, 2130903044, null));
    addView(this.mContentView);
    this.mFeedBack = ((EditText)this.mContentView.findViewById(2131230742));
    this.mEmail = ((EditText)this.mContentView.findViewById(2131230743));
    this.mSubmit = ((Button)this.mContentView.findViewById(2131230744));
