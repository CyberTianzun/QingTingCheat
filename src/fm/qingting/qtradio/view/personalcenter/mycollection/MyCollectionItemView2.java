  ...
  implements IMotionHandler
{
  ...
  {
    if (this.mRemind)
      paramCanvas.drawCircle(paramFloat1 + this.remindLayout.width / 2, paramFloat2 + this.remindLayout.height / 2, this.remindLayout.width / 2, this.mReminderPaint);
  }

  private String getCurrentPlayingProgram(ChannelNode paramChannelNode)
  {
    PlayingProgramNode localPlayingProgramNode = (PlayingProgramNode)InfoManager.getInstance().root().mPlayingProgramInfo.getCurrentPlayingProgram(paramChannelNode);
    if (localPlayingProgramNode == null)
      return "";
    return "正在直播：" + localPlayingProgramNode.programName;
  }
  ...
  private String getUpdateTimeString(long paramLong)
  {
    ...
    for (int n = 1; ; n = 0)
    {
      ...
      {
        return str + "更新";
        int i1 = (int)(l / 1000L / 3600L);
        if (i1 > 0)
        {
          Locale localLocale2 = Locale.CHINA;
          Object[] arrayOfObject2 = new Object[1];
          arrayOfObject2[0] = Integer.valueOf(i1);
          String.format(localLocale2, "%d小时前", arrayOfObject2);
        }
        int i2 = (int)(l / 1000L / 60L % 60L);
        if (i2 > 0)
        {
          Locale localLocale1 = Locale.CHINA;
          Object[] arrayOfObject1 = new Object[1];
          arrayOfObject1[0] = Integer.valueOf(i2);
          String.format(localLocale1, "%d分钟前", arrayOfObject1);
        }
        str = "刚刚";
        continue;
        str = TimeUtil.msToDate5(paramLong);
      }
    }
  }
