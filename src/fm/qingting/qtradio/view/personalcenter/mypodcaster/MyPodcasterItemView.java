  ...
  implements IMotionHandler, InfoManager.ISubscribeEventListener
{
  ...
  public MyPodcasterItemView(Context paramContext, int paramInt)
  {
    ...
    this.mAvatarElement.setDefaultImageRes(2130838027);
  ...
  private void setDescText()
  {
    ...
    ChannelNode localChannelNode = (ChannelNode)this.mPodcasterInfo.getChannelNodes().get(0);
    TextViewElement localTextViewElement = this.mDescElement;
    if (localChannelNode == null);
    for (String str = "暂无专辑"; ; str = localChannelNode.title)
    {
