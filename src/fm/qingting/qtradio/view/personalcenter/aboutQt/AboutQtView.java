  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public AboutQtView(Context paramContext)
  {
    ...
    this.mLogoElement.setImageRes(2130837688);
  ...
  {
    Bitmap localBitmap = BitmapResourceCache.getInstance().getResourceCache(getResources(), this, 2130837685);
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    ...
    if (paramViewElement == this.mLogoElement)
    {
      ...
      if (l < 1000L + this.mLastTime)
      {
        this.mClickCnt = (1 + this.mClickCnt);
        if (this.mClickCnt == 3)
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mCopyright.setTextSize(0.54F * this.copyrightLayout.height);
    ...
    this.mSmallLogoElement.setTextSize(0.6F * this.smallLayout.height);
    int i = (this.standardLayout.height - this.logoLayout.height - 2 * this.buttonLayout.height - this.smallLayout.getBottom()) / 3;
    this.mLogoElement.measure(this.logoLayout.leftMargin, i + this.logoLayout.topMargin, this.logoLayout.getRight(), i + this.logoLayout.getBottom());
    this.mFollowIcon.measure(this.buttonLayout.leftMargin, i * 2 + this.logoLayout.height + this.iconLayout.topMargin, this.buttonLayout.leftMargin + this.iconLayout.width, i * 2 + this.logoLayout.height + this.iconLayout.getBottom());
    this.mFollowElement.measure(this.buttonLayout.leftMargin + this.iconLayout.getRight(), i * 2 + this.logoLayout.height, this.buttonLayout.getRight(), i * 2 + this.logoLayout.height + this.buttonLayout.height);
    this.mEnterIcon.measure(this.buttonLayout.leftMargin, i * 2 + this.logoLayout.height + this.buttonLayout.height + this.iconLayout.topMargin, this.buttonLayout.leftMargin + this.iconLayout.width, i * 2 + this.logoLayout.height + this.buttonLayout.height + this.iconLayout.getBottom());
    this.mEnterElement.measure(this.buttonLayout.leftMargin + this.iconLayout.getRight(), i * 2 + this.logoLayout.height + this.buttonLayout.height, this.buttonLayout.getRight(), i * 2 + this.logoLayout.height + 2 * this.buttonLayout.height);
    this.mFollowElement.setTextSize(0.45F * this.buttonLayout.height);
    this.mEnterElement.setTextSize(0.45F * this.buttonLayout.height);
