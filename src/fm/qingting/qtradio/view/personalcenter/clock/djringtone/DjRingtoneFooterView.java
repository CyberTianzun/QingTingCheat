  ...
  implements View.OnClickListener
{
  ...
  private void drawCheckState(Canvas paramCanvas)
  {
    if (this.checked)
    {
      ...
      paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCacheByParent(getResources(), this.hashCode, 2130837748), null, this.mCheckBgRect, this.mPaint);
      return;
    }
