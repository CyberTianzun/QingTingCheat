  ...
  implements IEventHandler
{
  ...
  public void onEvent(Object paramObject1, String paramString, Object paramObject2)
  {
    if (paramString.equalsIgnoreCase("itemCallback"))
    {
      ...
      if (str.equalsIgnoreCase("changeCheckState"))
        if (this.checkList == i)
        {
          this.checkList = -1;
    ...
    while ((!paramString.equalsIgnoreCase("uncheckAll")) || (this.checkList == -1))
    {
      ...
      while (!str.equalsIgnoreCase("previewRingtone"));
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      if (paramString.equalsIgnoreCase("setRingtone"))
      {
        ...
        if ((str == null) || (InfoManager.getInstance().root().mRingToneInfoNode.mLstRingToneNodes == null) || (InfoManager.getInstance().root().mRingToneInfoNode.mLstRingToneNodes.size() == 0))
          break;
        for (int i = 0; i < InfoManager.getInstance().root().mRingToneInfoNode.mLstRingToneNodes.size(); i++)
          if (str.equalsIgnoreCase(((RingToneNode)InfoManager.getInstance().root().mRingToneInfoNode.mLstRingToneNodes.get(i)).ringToneId))
          {
            this.checkList = i;
