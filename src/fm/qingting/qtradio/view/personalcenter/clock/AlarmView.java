  ...
  implements IEventHandler, IMotionHandler
{
  ...
  private void hideDeleteButton()
  {
    ...
    {
      ObjectAnimator localObjectAnimator = ObjectAnimator.ofFloat(this.mConfirmView, "translationY", new float[] { 0.0F });
  ...
  private void showDeleteButton()
  {
    if (QtApiLevelManager.isApiLevelSupported(11))
    {
      ...
      ObjectAnimator localObjectAnimator = ObjectAnimator.ofFloat(localGeneralManageView, "translationY", arrayOfFloat);
      AnimatorSet localAnimatorSet = new AnimatorSet();
      localAnimatorSet.play(localObjectAnimator);
      localAnimatorSet.setDuration(200L);
      localAnimatorSet.start();
