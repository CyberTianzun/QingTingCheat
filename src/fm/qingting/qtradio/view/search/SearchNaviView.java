...
public class SearchNaviView extends QtView
  implements ViewElement.OnElementClickListener
{
  ...
  public SearchNaviView(Context paramContext)
  {
    ...
    this.mBack.setBackground(2130837924, 2130837923);
    ...
    this.mZoomElement.setImageRes(2130837932);
    addElement(this.mZoomElement, i);
    this.mDeleteButtonViewElement = new ButtonViewElement(paramContext);
    this.mDeleteButtonViewElement.setBackground(2130837926, 2130837926);
    ...
    this.mVoiceButtonViewElement.setBackground(2130838042, 2130838042);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mSearchButtonViewElement.setTextSize(0.5F * this.searchLayout.height);
