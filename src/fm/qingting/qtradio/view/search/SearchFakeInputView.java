...
public class SearchFakeInputView extends QtListItemView
{
  ...
  private void drawButton(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCache(getResources(), this, 2130837932), null, this.mSearchRect, this.mPaint);
    ...
    paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCache(getResources(), this, 2130838042), null, this.mVoiceRect, this.mPaint);
  }
