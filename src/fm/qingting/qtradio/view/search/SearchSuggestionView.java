  ...
  implements IEventHandler
{
  ...
  public void onEvent(Object paramObject1, String paramString, Object paramObject2)
  {
    ...
    {
      String str = (String)((ItemParam)paramObject2).param;
      QTMSGManage.getInstance().sendStatistcsMessage("search_suggestion");
      this.mSearchView.submitQuery(str);
    }
  }
  ...
  protected void setSubscribeListener(SearchViewNew paramSearchViewNew)
  {
    this.mSearchView = paramSearchViewNew;
  }
