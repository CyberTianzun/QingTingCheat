...
public class UserTitleView extends ViewGroupViewImpl
{
  ...
  {
    super(paramContext);
    setBackgroundResource(2130838009);
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    {
      localUserProfile = (UserProfile)paramObject;
    ...
    String str = localUserProfile.getUserInfo().snsInfo.sns_avatar;
    this.mAvatarView.setImageUrl(str);
    this.mName.setText(localUserProfile.getUserInfo().snsInfo.sns_name);
  }
}
