  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public BannerItemView(Context paramContext)
  {
    ...
    this.mImgBackground.setImageRes(2130838007);
    ...
    this.mCloseBtn.setBackground(0, 2130838008);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i = (this.itemLayout.height - this.closeLayout.height) / 2;
    int j = this.itemLayout.width - this.closeLayout.getLeft() - this.closeLayout.width;
    this.mCloseBtn.measure(j, i, j + this.closeLayout.width, i + this.closeLayout.height);
