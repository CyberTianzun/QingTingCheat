...
public class ErrorLogPopView extends QtView
{
  ...
  public ErrorLogPopView(Context paramContext)
  {
    ...
    this.mCopyElement.setOnElementClickListener(new ViewElement.OnElementClickListener()
    {
      ...
      {
        String str = ErrorLogPopView.this.mLogElement.getText();
        if (str != null)
          ErrorLogPopView.this.copy(str);
      }
    });
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mHidElement.measure(this.buttonLayout.getRight() + this.buttonLayout.leftMargin, this.standardLayout.height - this.buttonLayout.getBottom(), 2 * this.buttonLayout.getRight(), this.standardLayout.height - this.buttonLayout.topMargin);
