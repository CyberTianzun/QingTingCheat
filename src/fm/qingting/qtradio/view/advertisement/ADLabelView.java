...
public class ADLabelView extends ViewImpl
{
  ...
  private void drawInfo(Canvas paramCanvas)
  {
    ...
    float f2 = localRect.right - localRect.left;
    float f3 = this.bgLayout.getLeft() + this.largeTextLayout.leftMargin + (this.bgLayout.width - f2) / 2.0F;
    float f4 = this.bgLayout.getTop() + (this.bgLayout.height - f1);
    paramCanvas.drawText(this.info, f3, f4, this.largeTextPaint);
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 2:
      ...
      Rect localRect = this.bgLayout.getRect();
      getLocalVisibleRect(localRect);
      this.inRect = localRect.contains(i, j);
      return true;
    case 4:
      this.inRect = false;
      return true;
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawRoundRect(new RectF(f1, f2, f1 + this.bgLayout.width, f2 + this.bgLayout.height), this.bgLayout.leftMargin, this.bgLayout.leftMargin, this.grayBgPaint);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.largeTextPaint.setTextSize(0.06F * this.bgLayout.width);
