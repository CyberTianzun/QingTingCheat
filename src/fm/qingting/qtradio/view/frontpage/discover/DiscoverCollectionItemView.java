  ...
  implements ViewElement.OnElementClickListener, InfoManager.ISubscribeEventListener
{
  ...
  private void checkLiveChannel()
  {
    ...
    if (localProgramNode != null)
    {
      ...
      this.mTimeElement.setText("播放时间：" + TimeUtil.msToDate3(1000L * localProgramNode.getAbsoluteStartTime()) + " - " + TimeUtil.msToDate3(1000L * localProgramNode.getAbsoluteEndTime()));
      return;
    }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (int j = 4; ; j = 0)
    {
      ...
      if (this.shouldReminder)
      {
        ...
        paramCanvas.drawCircle(this.updateLayout.leftMargin + this.updateLayout.width / 2, this.updateLayout.topMargin + this.updateLayout.width / 2, this.updateLayout.width / 2, localPaint);
      }
      return;
    }
  }
  ...
  public void onNotification(String paramString)
  {
    ...
    {
      return;
      localProgramNode = this.mChannelNode.getProgramNodeByTime(System.currentTimeMillis());
    }
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    if (paramString.equalsIgnoreCase("content"))
    {
      ...
      this.mAvatarElement.setImageUrl(this.mChannelNode.getApproximativeThumb(120, 120, i));
      ...
      if ((this.mChannelNode.getUpdateTime() > SharedCfg.getInstance().getLatestBootstrapTime()) && (this.mChannelNode.channelType == i) && (SharedCfg.getInstance().getLatestBootstrapTime() > this.mChannelNode.viewTime))
      {
