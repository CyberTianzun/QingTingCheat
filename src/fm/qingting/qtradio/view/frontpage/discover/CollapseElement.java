...
class CollapseElement extends ViewElement
{
  ...
  protected void onDrawElement(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCacheByParent(getContext().getResources(), this.mOwnerId, 2130837696), null, this.mIconRect, this.mPaint);
