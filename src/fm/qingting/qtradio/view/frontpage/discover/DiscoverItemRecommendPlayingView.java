  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    if (this.mInfo != null)
    {
      ...
      String str1 = InfoManager.getInstance().h5Channel(this.mInfo.channelId);
      if ((str1 == null) || (str1.equalsIgnoreCase("")))
        break label98;
      String str2 = this.mInfo.channelName;
      ControllerManager.getInstance().redirectToActiviyByUrl(str1, str2, false);
      ChannelNode localChannelNode = ChannelHelper.getInstance().getChannel(this.mInfo.channelId, 0);
    ...
    while (true)
    {
      ...
      return;
      label98: ControllerManager.getInstance().openPlayController(0, this.mInfo.channelId, 0, true, this.mInfo.channelName);
    }
  }
