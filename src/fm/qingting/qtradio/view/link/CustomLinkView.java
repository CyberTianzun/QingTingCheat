  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public CustomLinkView(Context paramContext, int paramInt)
  {
    ...
    this.mCancelElement.setImageRes(2130837926);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int j = this.mTitleElement.getHeight();
    if (j < this.titleLayout.height)
    {
      int k = (i - j) / 2;
      this.mTitleElement.setTranslationY(k);
      this.mLabelElement.setTranslationY(k);
    }
    this.mBgElement.measure(0, 0, this.standardLayout.width, i);
    if (this.mArrowX > 0)
    {
      this.mArrowElement.measure(this.mArrowX - this.arrowLayout.width / 2, i, this.mArrowX + this.arrowLayout.width / 2, i + this.arrowLayout.height);
      i += this.arrowLayout.height;
    }
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    {
      this.mAvatarElement.setDefaultImageRes(2130837751);
      this.mLabelElement.setText("链接");
      return;
    }
    this.mAvatarElement.setDefaultImageRes(2130837750);
    this.mLabelElement.setText("音频");
  }
}
