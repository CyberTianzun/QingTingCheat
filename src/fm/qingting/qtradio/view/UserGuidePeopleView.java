...
class UserGuidePeopleView extends QtView
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i = this.checkLayout.topMargin;
    int j = (this.standardLayout.width - 2 * this.checkLayout.width) / 3;
    this.mWorkerElement.measure(j, i, j + this.checkLayout.width, i + this.checkLayout.height);
    int k = j + j + this.checkLayout.width;
    this.mStudentElement.measure(k, i, k + this.checkLayout.width, i + this.checkLayout.height);
    int m = (this.standardLayout.width - 2 * this.checkLayout.width) / 3;
    int n = this.secondCheckLayout.topMargin;
    this.mOlderElement.measure(m, n, m + this.checkLayout.width, n + this.checkLayout.height);
    int i1 = m + m + this.checkLayout.width;
    this.mElseElement.measure(i1, n, i1 + this.checkLayout.width, n + this.checkLayout.height);
    int i2 = this.titleLayout.topMargin;
    this.mTitleElement.measure(0, i2, this.standardLayout.width, i2 + this.titleLayout.height);
    int i3 = this.subTitleLayout.topMargin;
    this.mSubTitleElement.measure(0, i3, this.standardLayout.width, i3 + this.subTitleLayout.height);
