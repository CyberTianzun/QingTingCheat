...
public class DanmakuImageView extends QtView
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i = this.standardLayout.height - this.infoLayout.height;
    this.mInfoBackground.setTranslationY(i);
    this.mAvatarElement.setTranslationY(i);
    this.mNameElement.setTranslationY(i);
    this.mMessageElement.setTranslationY(i);
  ...
  public void setThumb()
  {
    ...
    {
      String str = localChannelNode.getApproximativeThumb(720, 574, true);
      this.mElement.setImageUrl(str, false);
      return;
    }
