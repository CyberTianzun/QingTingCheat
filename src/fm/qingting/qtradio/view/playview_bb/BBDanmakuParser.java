      ...
      for (int k = (int)(AlphaValue.MAX * Float.parseFloat(arrayOfString3[1])); ; k = j)
      {
        ...
        for (float f4 = Float.parseFloat(arrayOfString2[6]); ; f4 = 0.0F)
        {
          ...
          while (true)
          {
            ...
            DanmakuFactory.fillTranslationData(this.item, f1, f2, f6, f5, l3, l2, BBDanmakuParser.this.mDispScaleX, BBDanmakuParser.this.mDispScaleY);
            ...
            DanmakuFactory.fillLinePathData(this.item, arrayOfFloat, BBDanmakuParser.this.mDispScaleX, BBDanmakuParser.this.mDispScaleY);
            return;
            long l5 = l4;
            f5 = f8;
            f6 = f7;
      ...
      while (true)
      {
        if (paramString2.toLowerCase(Locale.getDefault()).trim().equals("d"))
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            this.item = DanmakuFactory.createDanmaku(j, BBDanmakuParser.this.mDisp);
            if (this.item != null)
            {
              this.item.time = l;
              this.item.textSize = (f * (BBDanmakuParser.this.mDispDensity - 0.6F));
              this.item.textColor = -11908534;
              this.item.drawableLeftResid = 2130837577;
