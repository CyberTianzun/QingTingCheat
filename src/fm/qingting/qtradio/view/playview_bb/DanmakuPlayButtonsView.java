  ...
  implements ViewElement.OnElementClickListener, IMediaEventListener, DownLoadInfoNode.IDownloadInfoEventListener
{
  ...
  public DanmakuPlayButtonsView(Context paramContext)
  {
    ...
    this.mPreElement.setBackground(2130837781, 2130837521, 2130837521);
    ...
    this.mNextElement.setBackground(2130837774, 2130837516, 2130837516);
    ...
    this.mScheduleElement.setBackground(2130837783, 2130837522);
    ...
    this.mDownloadElement.setBackground(2130837763, 2130837514);
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        this.mDownloadElement.setBackground(2130837763, 2130837514);
        break;
        label290: ChannelNode localChannelNode1 = InfoManager.getInstance().root().getCurrentPlayingChannelNode();
