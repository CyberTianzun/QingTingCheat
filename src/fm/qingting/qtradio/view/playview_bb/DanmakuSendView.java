  ...
  implements IEventHandler, INavigationBarListener
{
  ...
  public DanmakuSendView(Context paramContext)
  {
    ...
    this.mNaviView = new NavigationBarTopView(paramContext);
    ...
    this.mEditText.addTextChangedListener(new TextWatcher()
    {
      ...
      {
        int i = 60 - DanmakuSendView.this.mEditText.getText().length();
        DanmakuSendView.this.mTextCountView.setText(i + "字");
      }
    });
  ...
  public void update(String paramString, Object paramObject)
  {
    if (paramString.equalsIgnoreCase("setData"))
    {
      ...
      this.image = ((Bitmap)localHashMap.get("image"));
      this.uri = ((String)localHashMap.get("uri"));
