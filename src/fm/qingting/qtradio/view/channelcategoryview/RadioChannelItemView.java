  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public RadioChannelItemView(Context paramContext, int paramInt)
  {
    ...
    this.mAudienceLabelElement.setImageRes(2130837697);
  ...
  public void update(String paramString, Object paramObject)
  {
    if (paramString.equalsIgnoreCase("content"))
    {
      ...
      localChannelNode = this.mNode.convertToChannelNode();
      if (localChannelNode != null)
      {
        this.mAvatarElement.setImageUrl(localChannelNode.getApproximativeThumb());
        this.mTitleElement.setText(localChannelNode.title, false);
        this.mInfoElement.setText(getCurrentPlayingProgram(), false);
        str = getAudienceCount(localChannelNode);
        if (str != null)
          break label123;
        this.mAudienceLabelElement.setVisible(4);
        this.mAudienceTextElement.setText(str, false);
      }
    }
    label123: 
