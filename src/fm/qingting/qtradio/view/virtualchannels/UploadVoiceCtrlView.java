...
public class UploadVoiceCtrlView extends ViewGroupViewImpl
{
  ...
  private void generateRect()
  {
    ...
    int m = i + this.sideBtnLayout.width / 2 + this.sideBtnLayout.width / 4;
    this.cBtnRect.set(i - this.centerBtnLayout.width / 2, j - this.centerBtnLayout.height / 2, i + this.centerBtnLayout.width / 2, j + this.centerBtnLayout.height / 2);
    this.lBtnRect.set(k - this.sideBtnLayout.width / 2, j - this.sideBtnLayout.height / 2, k + this.sideBtnLayout.width / 2, j + this.sideBtnLayout.height / 2);
  ...
  private int getSelectedIndex()
  {
    ...
    {
      return i;
      if ((!this.cBtnRect.contains((int)this.mLastMotionX, (int)this.mLastMotionY)) || (this.mStep != i))
        break;
    }
    while (allowRecStop());
    return 5;
  ...
  private void setTitleTime()
  {
    ...
    case 0:
      ...
      this.titleView.setText("最大录音时长 " + TimeUtil.mSecToTime2(1000L * RecorderManager.getInstance().getMaxDurationSec()));
      return;
    case 1:
      this.titleView.setTextColor(SkinManager.getUploadPageElementColor());
      this.titleView.setText("当前录音时长 " + TimeUtil.mSecToTime2(1000L * this.mProcessTimeSec));
      return;
    case 2:
    }
    ...
    if (this.mIsPlaying)
    {
      this.titleView.setText("播放时长 " + TimeUtil.mSecToTime2(1000L * this.mProcessTimeSec));
      return;
    }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    generateRect();
    this.titleView.setTextSize(0, 0.85F * this.titleLayout.height);
