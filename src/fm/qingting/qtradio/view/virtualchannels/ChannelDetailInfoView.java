  ...
  implements ViewElement.OnElementClickListener, InfoManager.ISubscribeEventListener, RootNode.IInfoUpdateEventListener
{
  ...
  public ChannelDetailInfoView(Context paramContext)
  {
    ...
    this.mPic.setDefaultImageRes(2130837898);
  ...
  private void setFollowBtn(UserInfo paramUserInfo)
  {
    ...
    if ((paramUserInfo != null) && (CloudCenter.getInstance().isLogin()))
    {
    ...
    if (this.mIsFollow)
      this.mPodcasterFollowBtn.setBackground(2130838031, 2130838030);
    while (true)
    {
      invalidate();
      return;
      this.mPodcasterFollowBtn.setBackground(2130838029, 2130838028);
    }
  }
  ...
  public void onElementClick(ViewElement paramViewElement)
  {
    ...
    while (true)
    {
      ...
      if ((str == null) || (str.equalsIgnoreCase("")))
        break;
      ControllerManager.getInstance().redirectToActiviyByUrl(str, null, true);
      return;
  ...
  public void onNotification(String paramString)
  {
    ...
    do
    {
      do
      {
        do
          return;
        while ((!paramString.equalsIgnoreCase("RECV_PODCASTER_LATEST")) || (!CloudCenter.getInstance().isLogin()));
    ...
    while ((localUserProfile == null) || (localUserProfile.getUserInfo() == null) || (TextUtils.isEmpty(localUserProfile.getUserInfo().snsInfo.sns_id)));
  ...
  public void update(String paramString, Object paramObject)
  {
    if (paramString.equalsIgnoreCase("ca"))
      if (QtApiLevelManager.isApiLevelSupported(11))
        setAlpha(1.0F - 1.3F * ((Float)paramObject).floatValue());
    label158: label188: label334: 
    do
    {
      do
      {
      ...
      String str = this.mNode.getApproximativeThumb(250, 250, true);
    ...
    label258: label275: setPodcasterInfo((UserInfo)paramObject);
  }
}
