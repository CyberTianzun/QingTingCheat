  ...
  public TopHistoryItemView(Context paramContext)
  {
    ...
    this.mBg.setOnElementClickListener(new ViewElement.OnElementClickListener()
    {
      public void onElementClick(ViewElement paramAnonymousViewElement)
      {
        ...
        {
          ChannelNode localChannelNode = ChannelHelper.getInstance().getChannel(TopHistoryItemView.this.mProgramNode);
    ...
    this.mArrowIe.setImageRes(2130837991);
  ...
  public void update(String paramString, Object paramObject)
  {
    if (paramString.equalsIgnoreCase("content"))
    {
      try
      {
        ...
        {
          this.mPlayPercentTe.setText(100 * this.mMetaData.position / this.mMetaData.duration + "%");
          return;
