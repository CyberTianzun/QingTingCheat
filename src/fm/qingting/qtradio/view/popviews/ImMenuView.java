  ...
  implements BaseUserInfoPool.OnBaseUserinfoPutListener
{
      ...
      public void OnArrayClick(ViewElement paramAnonymousViewElement, int paramAnonymousInt)
      {
        ...
        case 0:
          ...
          do
          {
            ...
            localViewController = ControllerManager.getInstance().getLastViewController();
          }
          while ((localViewController == null) || (!localViewController.controllerName.equalsIgnoreCase("imchat")));
          localViewController.config("atTa", ImMenuView.this.mMessage.mFromName);
          return;
        case 1:
          ImMenuView.this.dispatchActionEvent("cancelPopWithoutAnimation", null);
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    if (paramString.equalsIgnoreCase("setBubbleData"))
    {
      ...
      str1 = this.mMessage.mFromAvatar;
      if ((str1 != null) && (str1.length() != 0))
        break label153;
      str2 = BaseUserInfoPool.getAvatar(this.mMessage.mFromID);
    ...
    while (true)
    {
      ...
      setData(bool);
      return;
      label117: if (!(paramObject instanceof UserInfo))
        break;
      this.mMessage = createMessage((UserInfo)paramObject);
      bool = false;
      break;
      label141: this.mAvatarElement.setImageUrl(str2);
      continue;
      label153: this.mAvatarElement.setImageUrl(str1);
    }
  }
}
