...
public class MainMenuView extends QtView
{
  ...
  public MainMenuView(Context paramContext)
  {
    ...
    localArrayList.add(new ButtonItem(localResources.getString(2131492884), 0));
    localArrayList.add(new ButtonItem(localResources.getString(2131492885), 0));
    localArrayList.add(new ButtonItem(localResources.getString(2131492886), 0));
    localArrayList.add(new ButtonItem(localResources.getString(2131492887), 0));
