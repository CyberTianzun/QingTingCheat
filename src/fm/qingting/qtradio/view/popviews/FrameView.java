  ...
  implements ViewElement.OnElementClickListener
{
  ...
  private static final int STATE_SPEECH;
  ...
  private Runnable mRunnable = new Runnable()
  {
    public void run()
    {
      ...
      FrameView.access$102(FrameView.this, (1 + FrameView.this.mCurrentLineCount) % 8);
      FrameView.access$302(FrameView.this, 60 + 20 * FrameView.this.mCurrentLineCount);
    }
  };
  ...
  public FrameView(Context paramContext)
  {
    ...
    this.mSeperatorElement.setImageRes(2130838037);
    addElement(this.mSeperatorElement);
    this.mVerticalElement = new ImageViewElement(paramContext);
    this.mVerticalElement.setImageRes(2130838046);
    ...
    this.mLineElement[0].setImageRes(2130838038);
    this.mLineElement[1].setImageRes(2130838039);
    this.mLineElement[2].setImageRes(2130838040);
    this.mLineElement[3].setImageRes(2130838041);
    this.mLineElement[4].setImageRes(2130838041);
    this.mLineElement[5].setImageRes(2130838041);
    this.mLineElement[6].setImageRes(2130838041);
    this.mLineElement[7].setImageRes(2130838041);
    ...
    this.mSpeechRecognizer.setRecognitionListener(new RecognitionListener()
    {
      ...
      public void onResults(Bundle paramAnonymousBundle)
      {
        ...
        {
          ArrayList localArrayList = paramAnonymousBundle.getStringArrayList("results_recognition");
