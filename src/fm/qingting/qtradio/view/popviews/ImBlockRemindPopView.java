...
public class ImBlockRemindPopView extends QtView
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mBg.measure(0, this.standardLayout.height - this.buttonsLayout.height - i - 2 * this.nameLayout.topMargin, this.standardLayout.width, this.standardLayout.height);
    this.mNameElement.setTranslationY(this.standardLayout.height - this.buttonsLayout.height - i - 2 * this.nameLayout.topMargin);
