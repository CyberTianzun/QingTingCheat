...
public class FmScanPopView extends QtView
{
  ...
  public FmScanPopView(Context paramContext)
  {
    ...
    arrayOfObject[0] = Integer.valueOf(this.mCount);
    localTextViewElement.setText(String.format("已有%d个免流量电台可用", arrayOfObject), false);
  ...
  public void update(String paramString, Object paramObject)
  {
    if ((paramString.equalsIgnoreCase("setBubbleData")) && (paramObject != null))
    {
      ...
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = Integer.valueOf(this.mCount);
      localTextViewElement.setText(String.format("已有%d个免流量电台可用", arrayOfObject), true);
    }
  }
}
