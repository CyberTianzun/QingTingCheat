...
public class CategoryOrderManageView extends ViewGroupViewImpl
{
  ...
  {
    int i = this.mTagView.getMeasuredHeight();
    this.mTagView.layout(0, 0, paramInt3 - paramInt1, i);
    this.mContainer.layout(0, i, paramInt3 - paramInt1, i + this.mContainer.getMeasuredHeight());
    this.mTagView2.layout(0, i + this.mContainer.getMeasuredHeight(), paramInt3 - paramInt1, i + this.mContainer.getMeasuredHeight() + this.mTagView2.getMeasuredHeight());
  }
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    {
      CategoryResortPopView.CategoryResortInfo localCategoryResortInfo = (CategoryResortPopView.CategoryResortInfo)paramObject;
  ...
  private class ResortAdapter extends DragDropAdapter
  {
    ...
    {
      for (int i = 0; i < CategoryOrderManageView.this.mDatas.size(); i++)
      {
