  ...
  implements DraggableItem
{
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    {
      localCategoryNode = (CategoryNode)paramObject;
      this.mIcon.setImageRes(IconManage.getNormalRes(localCategoryNode.sectionId));
      this.mTitle.setText(localCategoryNode.name);
    }
