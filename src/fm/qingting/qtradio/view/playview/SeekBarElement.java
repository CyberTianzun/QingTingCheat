...
public class SeekBarElement extends AbsSeekBarElement
{
  ...
  {
    paramCanvas.drawBitmap(BitmapResourceCache.getInstance().getResourceCacheByParent(getContext().getResources(), this.mOwnerId, 2130837797), null, this.mThumbRect, this.mPaint);
  }
