...
public class CharacterParser
{
  ...
  private int getChsAscii(String paramString)
  {
    ...
    System.out.println("ERROR:ChineseSpelling.class-getChsAscii(String chs)" + localException2);
    label71: return i;
    label73: if (arrayOfByte.length == 1);
    for (int i = arrayOfByte[0]; ; i = 0)
    {
      try
      {
