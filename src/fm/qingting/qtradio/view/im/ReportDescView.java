...
public class ReportDescView extends QtView
{
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    if (paramString.equalsIgnoreCase("setData"))
    {
      ...
      this.mNameElement.setText(localIMMessage.mFromName, false);
      this.mDateElement.setText(TimeUtil.msToDate2(1000L * localIMMessage.publish), false);
      this.mContentElement.setText(localIMMessage.mMessage);
      str1 = localIMMessage.mFromAvatar;
      if ((str1 != null) && (str1.length() != 0))
        break label99;
      String str2 = BaseUserInfoPool.getAvatar(localIMMessage.mFromID);
      if (str2 != null)
        this.mAvatarElement.setImageUrl(str2);
    }
    return;
    label99: this.mAvatarElement.setImageUrl(str1);
  }
}
