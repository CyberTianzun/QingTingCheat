...
public class ImContactsView extends ViewGroupViewImpl
{
  ...
  private void setData(List<UserInfo> paramList)
  {
    ...
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("群组", 2130837818, 0)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("关注", 2130837817, 1)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("粉丝", 2130837816, 2)));
    localArrayList1.add(new SpecialPinnedItem(2, new SpecialContactsItem("黑名单", 2130837815, 3)));
