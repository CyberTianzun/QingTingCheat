  ...
  implements ViewElement.OnElementClickListener
{
  ...
  public void update(String paramString, Object paramObject)
  {
    ...
    if (paramString.equalsIgnoreCase("content"))
    {
      ...
      SnsInfo localSnsInfo = this.mDtc.snsInfo;
      this.mInfoElement.setText(localSnsInfo.signature, false);
      this.mTitleElement.setText(localSnsInfo.sns_name, false);
      this.mAvatarElement.setImageUrl(localSnsInfo.sns_avatar);
      str = localSnsInfo.sns_gender;
    ...
    while (true)
    {
      ...
      invalidate();
      return;
      label113: if (!str.equalsIgnoreCase("f"))
        i = 2130837587;
    }
  }
}
