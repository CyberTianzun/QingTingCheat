...
public class SearchSpecialExitAnimation extends SwitchAnimation
{
  ...
  protected Animation getCloseAnimation()
  {
    ...
    ScaleAnimation localScaleAnimation = new ScaleAnimation(1.0F, 1.0F, 1.0F, 1.0F - (ScreenType.getNaviHeight() + ScreenType.getMiniHeight()) / ScreenType.getHeight(), ScreenType.getWidth() / 2, (ScreenType.getHeight() - ScreenType.getMiniHeight() + ScreenType.getNaviHeight()) / 2);
