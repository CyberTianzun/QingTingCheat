...
public class SearchSpecialEnterAnimation extends SwitchAnimation
{
  ...
  protected Animation getOpenAnimation()
  {
    ...
    ScaleAnimation localScaleAnimation = new ScaleAnimation(1.0F, 1.0F, 1.0F - (ScreenType.getNaviHeight() + ScreenType.getMiniHeight()) / ScreenType.getHeight(), 1.0F, ScreenType.getWidth() / 2, (ScreenType.getHeight() - ScreenType.getMiniHeight() + ScreenType.getNaviHeight()) / 2);
