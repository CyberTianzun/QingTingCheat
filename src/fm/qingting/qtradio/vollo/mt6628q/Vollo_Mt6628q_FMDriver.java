...
public class Vollo_Mt6628q_FMDriver extends FMDriver
{
  ...
  private boolean enableFMAudio(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      continue;
      label225: Log.e("Mt6628q_FM", "enableFMAudio gained focus [failed]");
      return false;
  ...
  private void loadAudioSystem()
  {
    try
    {
      ...
      Class localClass1 = this.audioSystemClass;
      Class[] arrayOfClass1 = new Class[2];
      arrayOfClass1[0] = Integer.TYPE;
      arrayOfClass1[1] = Integer.TYPE;
      this.setForceUseMethod = localClass1.getMethod("setForceUse", arrayOfClass1);
      Class localClass2 = this.audioSystemClass;
      Class[] arrayOfClass2 = new Class[1];
      arrayOfClass2[0] = Integer.TYPE;
      this.getForceUse = localClass2.getMethod("getForceUse", arrayOfClass2);
      return;
    }
  ...
  public int getCurrentChannel()
    throws Exception
  {
    return (int)(10.0F * this.currentFreq);
  }
  ...
  public class ScanThread extends Thread
  {
    ...
    public void run()
    {
      ...
      Vollo_Mt6628q_FMDriver.this.handler.sendMessage(localMessage1);
      while (true)
      {
        ...
        if ((f2 < f1) || (f2 < 87.0F))
        {
          ...
          Vollo_Mt6628q_FMDriver.this.handler.sendMessage(localMessage2);
        ...
        localMessage3.arg1 = Vollo_Mt6628q_FMDriver.this.toHzFormat(f2);
        localMessage3.what = 2;
        Vollo_Mt6628q_FMDriver.this.handler.sendMessage(localMessage3);
        f1 = f2;
      }
    }
  }
