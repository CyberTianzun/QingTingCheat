...
public enum SharedCfg
{
  ...
  static
  {
    SharedCfg[] arrayOfSharedCfg = new SharedCfg[1];
    arrayOfSharedCfg[0] = INSTANCE;
  }
  ...
  private void initBubbleList()
  {
    ...
    if (this.mLstAllowBubble == null)
    {
      ...
      str = this.sharedPreference.getString("bubble_program_list", "");
    ...
    {
      return;
      label50: String[] arrayOfString = str.split("_");
      for (int i = 0; i < arrayOfString.length; i++)
        this.mLstAllowBubble.add(arrayOfString[i]);
    }
  }
  ...
  private void initChannelBubbleList()
  {
    ...
    if (this.mLstAllowChannelBubble == null)
    {
      ...
      str = this.sharedPreference.getString("bubble_channel_list", "");
      if (!str.equalsIgnoreCase("all"))
        break label50;
      this.allowAllBubble = true;
    }
    while (true)
    {
      ...
      label50: String[] arrayOfString = str.split("_");
      for (int i = 0; i < arrayOfString.length; i++)
        this.mLstAllowChannelBubble.add(arrayOfString[i]);
    }
  }
  ...
  private void initFilterList()
  {
    if (this.mLstFilter == null)
    {
      ...
      String str = this.sharedPreference.getString("KEY_FILTER_LIVEROOM", "");
      if ((str != null) && (!str.equalsIgnoreCase("")))
      {
        String[] arrayOfString = str.split("_");
        for (int i = 0; i < arrayOfString.length; i++)
          this.mLstFilter.add(arrayOfString[i]);
      }
    }
  }

  private void initLocalLiveRoom()
  {
    String str;
    if (this.mLstLocalLiveRoom == null)
    {
      this.mLstLocalLiveRoom = new ArrayList();
      str = this.sharedPreference.getString("local_liveroom_list", "");
      if (!str.equalsIgnoreCase("all"))
        break label50;
      this.allowLocalLiveRoom = true;
    }
    while (true)
    {
      return;
      label50: if ((str.equalsIgnoreCase("close")) || (str.equalsIgnoreCase("")))
      {
        this.disableLocalLiveRoom = true;
        return;
      }
      String[] arrayOfString = str.split("_");
      for (int i = 0; i < arrayOfString.length; i++)
        this.mLstLocalLiveRoom.add(arrayOfString[i]);
    }
  }
  ...
  {
    int i = 1 + getBootstrapCnt();
    this.editor.putInt("BOOTSTRAP_CNT", i);
    this.editor.commit();
  }
  ...
  public void addCheckedInProgramId(String paramString)
  {
    ...
    for (String str3 = "_" + paramString + "_"; ; str3 = str2 + "_" + paramString + "_")
    {
      this.editor.putString(str1, str3);
      this.editor.commit();
      return;
    }
  }
  ...
  {
    int i = 1 + this.sharedPreference.getInt("helpviewstage", 0);
    this.editor.putInt("helpviewstage", i);
    this.editor.commit();
  }
  ...
  {
    int i = 1 + this.sharedPreference.getInt("playstation", 1000);
    this.editor.putInt("playstation", i);
    this.editor.commit();
  }

  public void addPlayStation2min()
  {
    int i = 1 + this.sharedPreference.getInt("playstation2min", 0);
    this.editor.putInt("playstation2min", i);
    this.editor.commit();
  }

  public void addScanedStationCount()
  {
    int i = 1 + this.sharedPreference.getInt("scanstation", 0);
    this.editor.putInt("scanstation", i);
    this.editor.commit();
  }
  ...
  public boolean allowChannelBubble(String paramString)
  {
    ...
    while (true)
    {
      ...
      for (int i = 0; i < this.mLstAllowChannelBubble.size(); i++)
        if (((String)this.mLstAllowChannelBubble.get(i)).equalsIgnoreCase(str))
          return true;
    }
  }
  ...
  public String getAdvertisementImage(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      str = null;
      if (!bool)
        str = this.sharedPreference.getString(paramString, null);
    }
    return str;
  }
  ...
  {
    String str = this.sharedPreference.getString("play" + paramString, "");
  ...
  public boolean hasCheckedIn(String paramString)
  {
    ...
    do
    {
      return false;
      String str1 = "checkin_by_day" + TimeUtil.msToDate2(System.currentTimeMillis());
      str2 = this.sharedPreference.getString(str1, "");
    }
    while ((str2 == null) || (!str2.contains("-" + paramString + "_")));
    return true;
  }
  ...
  public boolean isFeatureNew(String paramString)
  {
    ...
    while (!hasAddedAlarm());
    return false;
    return this.sharedPreference.getBoolean(paramString, bool);
  }
  ...
  public boolean isLocalRecommendProgramIgnored(String paramString)
  {
    ...
    while (getLocalRecommndProgramIgnored().contains(str));
    return false;
  }
  ...
  public void saveFeedBackContactInfo(String paramString)
  {
    if (paramString == null)
      paramString = "";
    this.editor.putString("key_feedback_contactinfo", paramString);
    this.editor.commit();
  }
  ...
  {
    int i = 1 + getAppLocalCount();
    this.editor.putInt(getVertion() + "local", i);
    this.editor.commit();
  }

  public void setAppLocalCountMax()
  {
    int i = 10 + getAppLocalCount();
    this.editor.putInt(getVertion() + "local", i);
    this.editor.commit();
  }
  ...
  {
    int i = 1 + getAppStartCount();
    this.editor.putInt(getVertion() + "init", i);
    this.editor.commit();
  }
  ...
  {
    String str = "version" + String.valueOf(getVersionCode(paramContext));
    this.editor.putString("key_vertion", str);
    this.editor.commit();
  }
