...
public class GlobalCfg
{
  ...
  public String getDownloadPath()
  {
    ...
    if ((str == null) || (str.equalsIgnoreCase("")))
    {
      ...
      str = localFile.getPath() + File.separator + "QTDownloadRadio";
  ...
  public boolean getServiceKill()
  {
    ...
    if (str != null)
    {
      boolean bool2 = str.equalsIgnoreCase("true");
      bool1 = false;
      if (bool2)
        bool1 = true;
    }
  ...
  public String getValueFromDB(String paramString)
  {
    ...
    do
    {
      ...
      localResult = DataManager.getInstance().getData("getdb_common_record", null, localHashMap).getResult();
    }
    while (!localResult.getSuccess());
    String str = (String)localResult.getData();
    if ((str != null) && (str.equalsIgnoreCase("null")))
      str = null;
    if (useCache())
      this.mMapDBCache.put(paramString, str);
    return str;
  }
  ...
  public void setValueToDB(String paramString1, String paramString2, String paramString3)
  {
    if (paramString1 == null)
      return;
    if ((paramString3 != null) && (paramString3.equalsIgnoreCase("null")))
      paramString3 = null;
    if (useCache())
    {
      this.mMapDBCache.put(paramString1, paramString3);
      return;
    }
    HashMap localHashMap = new HashMap();
