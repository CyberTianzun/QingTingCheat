...
public class ChannelLastListenDB
{
  ...
  public long get(String paramString)
  {
    ...
    try
    {
      localCursor = localSQLiteDatabase.rawQuery("select * from channel_last_listen where " + "channel_id ='" + paramString + "'", null);
      if (localCursor.moveToNext())
      {
        long l = localCursor.getLong(localCursor.getColumnIndex("last_play_time"));
        localCursor.close();
        return l;
      }
    }
