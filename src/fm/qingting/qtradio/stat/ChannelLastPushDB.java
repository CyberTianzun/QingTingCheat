...
public class ChannelLastPushDB
{
  ...
  public long get(String paramString)
  {
    ...
    try
    {
      Cursor localCursor = localSQLiteDatabase.rawQuery("select * from channel_last_push where " + "channel_id ='" + paramString + "'", null);
      if (localCursor.moveToNext())
      {
        long l = localCursor.getLong(localCursor.getColumnIndex("last_push_time"));
        localCursor.close();
        return l;
      }
      localCursor.close();
