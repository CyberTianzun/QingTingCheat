...
public class AdPos extends Node
{
  ...
  public void onNodeUpdated(Object paramObject, Map<String, String> paramMap, String paramString)
  {
    ...
    if (paramString.equalsIgnoreCase("ADD_ADVERTISEMENT_INFO"))
    {
      if (paramMap == null)
        break label114;
      str1 = (String)paramMap.get("zone");
    }
    for (String str2 = (String)paramMap.get("posquery"); ; str2 = null)
    {
      if ((str1 != null) && (str2 != null) && (str1.equalsIgnoreCase(this.posid)) && (str2.equalsIgnoreCase(this.posquery)) && (this.parent != null) && (this.parent.nodeName.equalsIgnoreCase("recommendcategory")) && (isBanner()))
