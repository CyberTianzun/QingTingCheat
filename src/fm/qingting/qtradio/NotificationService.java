...
public class NotificationService extends Service
{
  ...
  private void handleIntent(Intent paramIntent)
  {
    if ((paramIntent != null) && (paramIntent.getAction() != null) && (paramIntent.getAction().equalsIgnoreCase("fm.qingting.qtradio.GEXIN_MESSAGE_BAK")))
    {
      ...
      if (localBundle != null)
      {
        localIntent.putExtra("msg", localBundle.getString("msg"));
        localIntent.putExtra("alias", localBundle.getString("alias"));
        localIntent.putExtra("topic", localBundle.getString("topic"));
        localIntent.putExtra("reg", localBundle.getString("reg"));
        localIntent.putExtra("type", String.valueOf(localBundle.getString("type")));
  ...
  public void onCreate()
  {
    try
    {
      ...
      localEditor.putString("DEVICE_ID", this.deviceId);
      localEditor.commit();
