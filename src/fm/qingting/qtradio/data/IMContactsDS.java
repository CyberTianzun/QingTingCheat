  ...
  implements IDataSource
{
  ...
  public IDataToken doCommand(DataCommand paramDataCommand, IDataRecvHandler paramIDataRecvHandler)
  {
    ...
    if (str.equalsIgnoreCase("insertdb_im_contacts"))
      return doInsertCommand(paramDataCommand);
    if (str.equalsIgnoreCase("getdb_im_group_contacts"))
      return doAcquireGroupCommand(paramDataCommand);
    if (str.equalsIgnoreCase("getdb_im_user_contacts"))
      return doAcquireUserCommand(paramDataCommand);
    if (str.equalsIgnoreCase("deletedb_im_contacts"))
      return doDeleteCommand(paramDataCommand);
    if (str.equalsIgnoreCase("updatedb_im_contacts"))
