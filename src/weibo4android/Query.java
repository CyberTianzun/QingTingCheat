...
public class Query
{
  ...
  private PostParameter getParameterValue(String paramString, Object paramObject)
  {
    if ((paramObject instanceof Boolean))
    {
      ...
      for (String str = "0"; ; str = "1")
        return new PostParameter(paramString, str);
    }
    ...
    throws WeiboException
  {
    ...
    while (j < i)
    {
      ...
      String str3 = "get" + str2 + str1.substring(1);
      try
      {
        Object localObject = Query.class.getMethod(str3, new Class[0]).invoke(this, new Object[0]);
        if (localObject != null)
          localArrayList.add(getParameterValue(str1, localObject));
        j++;
      }
    ...
    return (PostParameter[])localArrayList.toArray(new PostParameter[localArrayList.size()]);
  }
