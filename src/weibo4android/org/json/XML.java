    ...
    throws JSONException
  {
    ...
    while (true)
    {
      ...
      if (localObject4 == EQ)
      {
        ...
        localJSONObject.accumulate(str3, JSONObject.stringToValue((String)localObject5));
        localObject2 = null;
      }
      else
      {
    ...
    if (localObject2 == GT)
    {
      ...
      do
        while (true)
        {
          ...
          if (str2.length() > 0)
            localJSONObject.accumulate("content", JSONObject.stringToValue(str2));
        }
        ...
        else
        {
          if ((localObject2 instanceof JSONArray))
          {
            ...
            while (true)
            {
              ...
              break label225;
              break;
              label307: localStringBuffer.append(toString(localObject3, str3));
            }
          }
