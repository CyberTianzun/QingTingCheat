  ...
  public static class RenderingState
  {
    ...
    public int addCount(int paramInt1, int paramInt2)
    {
      ...
      default:
        return 0;
      case 1:
        this.r2lDanmakuCount = (paramInt2 + this.r2lDanmakuCount);
        return this.r2lDanmakuCount;
      case 6:
        this.l2rDanmakuCount = (paramInt2 + this.l2rDanmakuCount);
        return this.l2rDanmakuCount;
      case 5:
        this.ftDanmakuCount = (paramInt2 + this.ftDanmakuCount);
        return this.ftDanmakuCount;
      case 4:
        this.fbDanmakuCount = (paramInt2 + this.fbDanmakuCount);
        return this.fbDanmakuCount;
      case 7:
      }
      this.specialDanmakuCount = (paramInt2 + this.specialDanmakuCount);
      return this.specialDanmakuCount;
    }

    public int addTotalCount(int paramInt)
    {
      this.totalDanmakuCount = (paramInt + this.totalDanmakuCount);
