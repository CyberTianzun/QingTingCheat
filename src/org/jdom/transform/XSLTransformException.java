...
public class XSLTransformException extends JDOMException
{
  ...
  public XSLTransformException(String paramString)
  {
    super(paramString);
  }

  public XSLTransformException(String paramString, Exception paramException)
  {
 ...
 * Qualified Name:     org.jdom.transform.XSLTransformException
