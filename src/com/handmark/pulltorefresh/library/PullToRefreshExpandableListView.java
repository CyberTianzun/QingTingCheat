...
public class PullToRefreshExpandableListView extends PullToRefreshAdapterViewBase<ExpandableListView>
{
  ...
  protected ExpandableListView createRefreshableView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (Object localObject = new InternalExpandableListViewSDK9(paramContext, paramAttributeSet); ; localObject = new InternalExpandableListView(paramContext, paramAttributeSet))
    {
