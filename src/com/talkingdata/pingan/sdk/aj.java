...
public class aj
{
  private static final String h = "td-cache";
  private static final String i = "td-%.zip";
  private static final String j = "td.tmp-";
  private static final String k = "pref_longtime";
  private static final String l = "td.sdk.digest.";
  ...
  private t a(String paramString)
  {
    try
    {
      this.d = "td-%.zip".replace("%", this.c);
      this.e = ("td.tmp-" + this.c);
      this.f = ("td.sdk.digest." + this.c);
      File localFile1 = this.b.getDir("td-cache", 0);
      File localFile2 = new File(localFile1, this.d);
      if (a(localFile2))
      {
        t localt = (t)new DexClassLoader(localFile2.getAbsolutePath(), localFile1.getAbsolutePath(), null, aj.class.getClassLoader()).loadClass(paramString).newInstance();
        return localt;
      }
    }
  ...
  {
    URL localURL = new URL(paramt.c());
    String str1 = localURL.getHost();
    int i1 = localURL.getPort();
    if (i1 == -1)
      i1 = localURL.getDefaultPort();
    ag localag = new ag(new String(aa.a(aa.a(n, o), m)), str1, i1);
    String str2 = localag.a(paramt.c());
    File localFile1;
    File localFile2;
    String str4;
    if (!aa.a(str2))
    {
      ...
      paramt.a(str3);
      if (!str3.equalsIgnoreCase(paramt.a()))
      {
        localFile1 = this.b.getDir("td-cache", 0);
        localFile2 = new File(localFile1, this.e);
        str4 = localag.a(paramt.d(), localFile2);
        if (str4 == null);
      }
    }
    try
    {
      File localFile3 = new File(localFile1, this.d);
      localFile3.delete();
      localFile2.renameTo(localFile3);
      ad.a(this.b, "pref_longtime", this.f, str4);
      paramt.e();
      return;
    }
  ...
  private boolean a(File paramFile)
  {
    ...
    //   64: invokestatic 480	com/talkingdata/pingan/sdk/aa:a	([B)Ljava/lang/String;
    //   67: astore 10
    //   69: aload_0
    //   70: getfield 333	com/talkingdata/pingan/sdk/aj:b	Landroid/content/Context;
    //   73: ldc 17
    //   75: aload_0
    //   76: getfield 331	com/talkingdata/pingan/sdk/aj:f	Ljava/lang/String;
    //   79: ldc_w 482
    //   82: invokestatic 485	com/talkingdata/pingan/sdk/ad:b	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   85: aload 10
  ...
  // ERROR //
  public t a(Context paramContext, String paramString1, String paramString2, Class paramClass1, Class paramClass2, String paramString3)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 494	com/talkingdata/pingan/sdk/aj:a	Lcom/talkingdata/pingan/sdk/t;
    //   6: ifnonnull +82 -> 88
    //   9: aload_0
    //   10: aload_1
    //   11: invokevirtual 498	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   14: putfield 333	com/talkingdata/pingan/sdk/aj:b	Landroid/content/Context;
    //   17: aload_0
    //   18: aload_3
    //   19: putfield 308	com/talkingdata/pingan/sdk/aj:c	Ljava/lang/String;
    //   22: aload_0
    //   23: monitorenter
    //   24: new 500	java/lang/Thread
    //   27: dup
    //   28: new 502	com/talkingdata/pingan/sdk/z
    //   31: dup
    //   32: aload_0
    //   33: aload 6
    //   35: invokespecial 505	com/talkingdata/pingan/sdk/z:<init>	(Lcom/talkingdata/pingan/sdk/aj;Ljava/lang/String;)V
    ...
    //   52: monitorexit
    //   53: aload_0
    //   54: getfield 494	com/talkingdata/pingan/sdk/aj:a	Lcom/talkingdata/pingan/sdk/t;
    //   57: ifnonnull +20 -> 77
    //   60: aload_0
    //   61: iconst_1
    //   62: putfield 298	com/talkingdata/pingan/sdk/aj:g	Z
    //   65: aload_0
    //   66: aload 5
    //   68: invokevirtual 371	java/lang/Class:newInstance	()Ljava/lang/Object;
    //   71: checkcast 373	com/talkingdata/pingan/sdk/t
    //   74: putfield 494	com/talkingdata/pingan/sdk/aj:a	Lcom/talkingdata/pingan/sdk/t;
    //   77: aload_0
    //   78: getfield 494	com/talkingdata/pingan/sdk/aj:a	Lcom/talkingdata/pingan/sdk/t;
    //   81: aload_1
    //   82: aload_2
    //   83: invokeinterface 520 3 0
    //   88: aload_0
    //   89: getfield 494	com/talkingdata/pingan/sdk/aj:a	Lcom/talkingdata/pingan/sdk/t;
    //   92: astore 8
    //   94: aload_0
    //   95: monitorexit
    //   96: aload 8
 ...
 * Qualified Name:     com.talkingdata.pingan.sdk.aj
