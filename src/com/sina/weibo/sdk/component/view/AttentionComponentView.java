...
public class AttentionComponentView extends FrameLayout
{
  ...
  private void execAttented()
  {
    ...
    localWidgetRequestParam.setUrl("http://widget.weibo.com/relationship/followsdk.php");
    localWidgetRequestParam.setSpecifyTitle(ResourceManager.getString(getContext(), "Follow", "关注", "關注"));
    localWidgetRequestParam.setAppKey(this.mAttentionParam.mAppKey);
    localWidgetRequestParam.setAttentionFuid(this.mAttentionParam.mAttentionUid);
    localWidgetRequestParam.setAuthListener(this.mAttentionParam.mAuthlistener);
    localWidgetRequestParam.setToken(this.mAttentionParam.mAccessToken);
    localWidgetRequestParam.setWidgetRequestCallback(new WidgetRequestParam.WidgetRequestCallback()
    {
      public void onWebViewResult(String paramAnonymousString)
      {
        String str = Utility.parseUri(paramAnonymousString).getString("result");
  ...
  private void init(Context paramContext)
  {
    ...
    this.mButton.setLayoutParams(localLayoutParams1);
    ...
    this.pbLoading.setLayoutParams(localLayoutParams2);
  ...
  private void loadAttentionState(RequestParam paramRequestParam)
  {
    ...
    requestAsync(getContext(), "https://api.weibo.com/2/friendships/show.json", localWeiboParameters, "GET", new RequestListener()
    {
      public void onComplete(String paramAnonymousString)
      {
        ...
        try
        {
          final JSONObject localJSONObject = new JSONObject(paramAnonymousString).optJSONObject("target");
          AttentionComponentView.this.getHandler().post(new Runnable()
          {
            public void run()
            {
              if (localJSONObject != null)
                AttentionComponentView.this.showFollowButton(localJSONObject.optBoolean("followed_by", false));
  ...
  private void showFollowButton(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      Drawable localDrawable2 = ResourceManager.getDrawable(getContext(), "timeline_relationship_icon_attention.png");
      this.mButton.setCompoundDrawablesWithIntrinsicBounds(localDrawable2, null, null, null);
    ...
    Drawable localDrawable1 = ResourceManager.getDrawable(getContext(), "timeline_relationship_icon_addattention.png");
    this.mButton.setCompoundDrawablesWithIntrinsicBounds(localDrawable1, null, null, null);
