  ...
  implements IWeiboShareAPI
{
  ...
  private boolean launchWeiboActivity(Activity paramActivity, String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    ...
    {
      LogUtil.e(TAG, localActivityNotFoundException.getMessage());
    }
    return false;
  }
  ...
  private void sendBroadcast(Context paramContext, String paramString1, String paramString2, String paramString3, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
      localIntent.putExtras(paramBundle);
    LogUtil.d(TAG, "intent=" + localIntent + ", extra=" + localIntent.getExtras());
  ...
  private boolean startShareWeiboActivity(Activity paramActivity, String paramString, BaseRequest paramBaseRequest, WeiboAuthListener paramWeiboAuthListener)
  {
    try
    {
      ...
      Intent localIntent = new Intent(paramActivity, WeiboSdkBrowser.class);
      localIntent.putExtras(localShareRequestParam.createRequestParamBundle());
  ...
  public boolean sendRequest(Activity paramActivity, BaseRequest paramBaseRequest, AuthInfo paramAuthInfo, String paramString, WeiboAuthListener paramWeiboAuthListener)
  {
    ...
    if ((isWeiboAppInstalled()) && (isWeiboAppSupportAPI()))
    {
      ...
      {
        SendMultiMessageToWeiboRequest localSendMultiMessageToWeiboRequest = (SendMultiMessageToWeiboRequest)paramBaseRequest;
        SendMessageToWeiboRequest localSendMessageToWeiboRequest = new SendMessageToWeiboRequest();
        localSendMessageToWeiboRequest.packageName = localSendMultiMessageToWeiboRequest.packageName;
        localSendMessageToWeiboRequest.transaction = localSendMultiMessageToWeiboRequest.transaction;
        localSendMessageToWeiboRequest.message = adapterMultiMessage2SingleMessage(localSendMultiMessageToWeiboRequest.multiMessage);
        return sendRequest(paramActivity, localSendMessageToWeiboRequest);
      }
      return sendRequest(paramActivity, paramBaseRequest);
    }
