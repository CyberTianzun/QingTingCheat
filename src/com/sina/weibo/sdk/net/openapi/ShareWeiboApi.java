...
public class ShareWeiboApi
{
  ...
  {
    WeiboParameters localWeiboParameters = buildUpdateParams(paramString2, null, null);
    localWeiboParameters.put("id", paramString1);
    localWeiboParameters.put("is_comment", String.valueOf(paramInt));
  ...
  {
    WeiboParameters localWeiboParameters = buildUpdateParams(paramString1, paramString2, paramString3);
    localWeiboParameters.put("pic", paramBitmap);
    requestAsync("https://api.weibo.com/2/statuses/upload.json", localWeiboParameters, "POST", paramRequestListener);
  }
}
