...
public class AsyncWeiboRunner
{
  ...
  private static class RequestRunner extends AsyncTask<Void, Void, AsyncWeiboRunner.AsyncTaskResult<String>>
  {
    ...
    protected AsyncWeiboRunner.AsyncTaskResult<String> doInBackground(Void[] paramArrayOfVoid)
    {
      try
      {
        AsyncWeiboRunner.AsyncTaskResult localAsyncTaskResult = new AsyncWeiboRunner.AsyncTaskResult(HttpManager.openUrl(this.mContext, this.mUrl, this.mHttpMethod, this.mParams));
        return localAsyncTaskResult;
      }
      catch (WeiboException localWeiboException)
      {
        return new AsyncWeiboRunner.AsyncTaskResult(localWeiboException);
      }
    }
