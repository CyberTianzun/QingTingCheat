...
public class b
{
  ...
  {
    s.a locala = new s.a(paramMMEntity).a(7).b(paramInt).c(3).a(new Promoter[] { paramPromoter });
    new h(paramContext, paramPromoter.url).a(locala).d(paramPromoter.title).a();
  }
  ...
  public static void a(a.a parama, Context paramContext, ExchangeDataService paramExchangeDataService, boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      localMMEntity = (MMEntity)paramExchangeDataService.b.clone();
      if (AlimmContext.getAliContext().getAppUtils().c(localPromoter.app_package_name))
      {
        d(paramContext, localMMEntity, localPromoter, paramInt);
        return;
      }
    }
    catch (CloneNotSupportedException localCloneNotSupportedException)
    {
      ...
      {
        a(parama, paramContext, localMMEntity, paramInt);
        return;
      }
      int i = localPromoter.landing_type;
      if ((paramBoolean) && (i == 0))
        i = 1;
      switch (i)
      {
    ...
    b(parama, paramContext, localMMEntity, paramInt);
    return;
    c(paramContext, localMMEntity, localPromoter, paramInt);
    return;
    b(paramContext, localMMEntity, localPromoter, paramInt);
    return;
    a(paramContext, localMMEntity, localPromoter, paramInt);
  }
  ...
  {
    s.a locala = new s.a(paramMMEntity).a(2).b(paramInt).c(3);
    Promoter[] arrayOfPromoter = new Promoter[1];
    arrayOfPromoter[0] = parama.a;
    locala.a(arrayOfPromoter).a().a();
    int i = paramContext.getResources().getIdentifier("taobao_xp_dialog_download_window", "style", paramContext.getPackageName());
    new DownloadDialog(paramContext, parama.a, parama.b, paramMMEntity, i, DownloadDialog.a.b).show();
  }
  ...
  private static void b(Context paramContext, MMEntity paramMMEntity, Promoter paramPromoter, int paramInt)
  {
    ...
    {
      Log.b(ExchangeConstants.LOG_TAG, localActivityNotFoundException.toString());
