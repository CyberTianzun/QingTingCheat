    ...
    while (true)
    {
      try
      {
        if ((this.d == true) && (this.f != null))
        {
          ...
          s.a locala = new a.a(this.h.getEntity()).f(this.b).g(i).h(1).a(-5);
          Promoter[] arrayOfPromoter = new Promoter[1];
          arrayOfPromoter[0] = this.a;
          ...
          if (!this.e)
          {
            ...
            this.f.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
            {
              public void onPrepared(MediaPlayer paramAnonymousMediaPlayer)
              {
                ...
                s.a locala = new s.a(MunionAudio.b(MunionAudio.this).getEntity()).a(0);
                Promoter[] arrayOfPromoter = new Promoter[1];
                arrayOfPromoter[0] = MunionAudio.this.a;
                locala.a(arrayOfPromoter).a().a();
          ...
          while (true)
          {
            this.f.setOnCompletionListener(new MediaPlayer.OnCompletionListener()
            {
              public void onCompletion(MediaPlayer paramAnonymousMediaPlayer)
              {
                ...
                s.a locala = new a.a(MunionAudio.b(MunionAudio.this).getEntity()).f(MunionAudio.this.b).g(i).h(0).a(-5);
                Promoter[] arrayOfPromoter = new Promoter[1];
                arrayOfPromoter[0] = MunionAudio.this.a;
                locala.a(arrayOfPromoter).a().a();
                if (MunionAudio.c(MunionAudio.this) != null)
            ...
            this.e = false;
            this.f.start();
            s.a locala = new s.a(this.h.getEntity()).a(0);
            Promoter[] arrayOfPromoter = new Promoter[1];
            arrayOfPromoter[0] = this.a;
            locala.a(arrayOfPromoter).a().a();
                ...
                public void a(c.c paramAnonymous2c, String paramAnonymous2String)
                {
                  ...
                  do
                  {
                    do
                    {
                      return;
                      b localb = new b();
                      MunionAudio.a(MunionAudio.this, localb.a() + ".mmsy/" + paramAnonymous2String);
                      Log.i("filePath:" + MunionAudio.a(MunionAudio.this), new Object[0]);
                      MunionAudio.a(MunionAudio.this, new MediaPlayer());
                      s.a locala = new s.a(MunionAudio.b(MunionAudio.this).getEntity()).a(-4);
                      Promoter[] arrayOfPromoter = new Promoter[1];
                      arrayOfPromoter[0] = MunionAudio.this.a;
                      locala.a(arrayOfPromoter).a().a();
    ...
    while (true)
    {
      try
      {
        if (((this.d == true) || (this.e == true)) && (this.f != null))
        {
          ...
          this.e = false;
          int i = this.f.getCurrentPosition();
          s.a locala = new a.a(this.h.getEntity()).f(this.b).g(i).h(2).a(-5);
          Promoter[] arrayOfPromoter = new Promoter[1];
          arrayOfPromoter[0] = this.a;
          locala.a(arrayOfPromoter).a().a();
