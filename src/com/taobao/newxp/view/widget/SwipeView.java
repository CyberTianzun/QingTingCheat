...
public class SwipeView extends HorizontalScrollView
{
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramInt >= getPageCount()) && (getPageCount() > 0))
    {
      ...
      if (!paramBoolean)
        break label119;
      smoothScrollTo(paramInt * this.l, 0);
    }
    while (true)
    {
      this.k = paramInt;
      if ((this.m != null) && (i1 != paramInt))
        this.m.onPageChanged(i1, paramInt);
      if ((this.p != null) && (i1 != paramInt))
        this.p.setCurrentPage(paramInt);
      ...
      paramInt = 0;
      break;
      label119: scrollTo(paramInt * this.l, 0);
    }
  }
  ...
  public void setPageControl(SwipeViewPointer paramSwipeViewPointer)
  {
    ...
    if (paramSwipeViewPointer != null)
    {
      ...
      paramSwipeViewPointer.setOnPageControlClickListener(new SwipeViewPointer.OnPageControlClickListener()
      {
        ...
        {
          SwipeView.this.smoothScrollToPage(-1 + SwipeView.a(SwipeView.this));
        }
    ...
    implements View.OnTouchListener
  {
    ...
    {
      int i = SwipeView.d(SwipeView.this) - (int)paramMotionEvent.getX();
      int j;
      if (i < 0)
        if (4 + this.c <= i)
        {
      ...
      label196: for (this.c = (SwipeView.d(SwipeView.this) - (int)paramMotionEvent.getX()); ; this.c = i)
      {
        this.d = j;
    ...
    private boolean c(MotionEvent paramMotionEvent)
    {
      ...
      float f2 = SwipeView.f(SwipeView.this).getMeasuredWidth() / SwipeView.g(SwipeView.this);
      float f3 = f1 / SwipeView.g(SwipeView.this);
      float f4;
      if (this.d == 1)
        if (this.c > SwipeView.f())
          if (SwipeView.a(SwipeView.this) < f2 - 1.0F)
            f4 = (int)(f3 + 1.0F) * SwipeView.g(SwipeView.this);
      while (true)
      {
        SwipeView.this.smoothScrollToPage((int)f4 / SwipeView.g(SwipeView.this));
        this.e = true;
        this.c = 0;
        SwipeView.b(SwipeView.this, false);
        SwipeView.c(SwipeView.this, false);
        return true;
        f4 = SwipeView.a(SwipeView.this) * SwipeView.g(SwipeView.this);
        continue;
        ...
        else
        {
          ...
          continue;
          if (this.c < -SwipeView.f())
            f4 = (int)f3 * SwipeView.g(SwipeView.this);
          else if (Math.round(f3) == 0)
            f4 = (int)f3 * SwipeView.g(SwipeView.this);
          else
            f4 = SwipeView.a(SwipeView.this) * SwipeView.g(SwipeView.this);
        }
