  ...
  private void a()
  {
    ...
    setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        ...
        {
          return false;
          if (SwipeViewPointer.b(SwipeViewPointer.this) < -1 + SwipeViewPointer.c(SwipeViewPointer.this))
          {
            ...
            else if (SwipeViewPointer.b(SwipeViewPointer.this) < -1 + SwipeViewPointer.c(SwipeViewPointer.this))
              SwipeViewPointer.a(SwipeViewPointer.this).goForwards();
          }
        }
      }
