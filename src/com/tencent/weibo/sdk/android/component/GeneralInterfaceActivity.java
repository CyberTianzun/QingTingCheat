  ...
  implements View.OnClickListener
{
  ...
  public void initInterface()
  {
    ...
    localTableRow1.addView(this.homeTimeLine);
    ...
    localTableRow1.addView(this.userTimeLine);
    ...
    localTableRow3.addView(this.addPicUrl);
    ...
    localTableRow3.addView(this.htTimeLine);
    ...
    localTableRow4.addView(this.userInfo);
    ...
    localTableRow4.addView(this.userOtherInfo);
    localTableLayout.addView(localTableRow4);
    ...
    localTableRow5.addView(this.userInfos);
    ...
    localTableRow5.addView(this.friendAdd);
    localTableLayout.addView(localTableRow5);
    TableRow localTableRow6 = new TableRow(this);
    ...
    localTableRow6.addView(this.friendIdolList);
    ...
    localTableRow6.addView(this.friendFunsList);
    localTableLayout.addView(localTableRow6);
    TableRow localTableRow7 = new TableRow(this);
    ...
    localTableRow7.addView(this.friendMutualList);
    ...
    localTableRow7.addView(this.friendCheck);
    localTableLayout.addView(localTableRow7);
    TableRow localTableRow8 = new TableRow(this);
    this.tReList = new Button(this);
    this.tReList.setText("转播获取转播列表");
    this.tReList.setId(1015);
    this.tReList.setOnClickListener(this);
    localTableRow8.addView(this.tReList);
    ...
    localTableRow8.addView(this.friendGetIntimateFriend);
    localTableLayout.addView(localTableRow8);
    TableRow localTableRow9 = new TableRow(this);
    ...
    localTableRow9.addView(this.lbsGetAroundPeople);
    ...
    localTableRow9.addView(this.lbsGetAroundNew);
    localTableLayout.addView(localTableRow9);
  ...
  public void onClick(View paramView)
  {
    ...
    while (true)
    {
      ...
      try
      {
        Bitmap localBitmap = BitmapFactory.decodeStream(this.context.getAssets().open("logo.png"));
        this.weiboAPI.addPic(this.context, "call telephone OKK", this.requestFormat, this.longitude, this.latitude, localBitmap, 0, 0, this.mCallBack, null, 4);
      }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    AccountModel localAccountModel = new AccountModel(this.accessToken);
    this.friendAPI = new FriendAPI(localAccountModel);
    this.timeLineAPI = new TimeLineAPI(localAccountModel);
    this.weiboAPI = new WeiboAPI(localAccountModel);
    this.userAPI = new UserAPI(localAccountModel);
    this.lbsAPI = new LbsAPI(localAccountModel);
    this.mCallBack = new HttpCallback()
    {
      public void onResult(Object paramAnonymousObject)
      {
        ...
        if ((localModelResult != null) && (localModelResult.isSuccess()))
        {
          ...
          localIntent.putExtra("data", localModelResult.getObj().toString());
