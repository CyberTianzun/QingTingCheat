  ...
  implements LbsAgent.OnGetLocationListener
{
  ...
  private void doSearchNearby(Location paramLocation)
  {
    ...
    while (true)
    {
      ...
      TaskRequestListener localTaskRequestListener = new TaskRequestListener(this.mSearchListener);
      HttpUtils.requestAsync(this.mToken, this.mContext, "http://fusion.qq.com/cgi-bin/qzapps/mapp_lbs_getnear.cgi", localBundle, "GET", localTaskRequestListener);
      return;
  ...
  public void deleteLocation(Activity paramActivity, Bundle paramBundle, IUiListener paramIUiListener)
  {
    ...
    while (true)
    {
      ...
      localBundle.putString("encrytoken", Util.encrypt("tencent&sdk&qazxc***14969%%" + this.mToken.getAccessToken() + this.mToken.getAppId() + this.mToken.getOpenId() + "qzone3.4"));
      g.b("openSDK_LOG", "location: delete params: " + localBundle);
      TaskRequestListener localTaskRequestListener = new TaskRequestListener(paramIUiListener);
      HttpUtils.requestAsync(this.mToken, this.mContext, "http://fusion.qq.com/cgi-bin/qzapps/mapp_lbs_delete.cgi", localBundle, "GET", localTaskRequestListener);
